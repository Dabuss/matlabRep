function [x,fval,exitflag,output,lambda,grad,hessian] = IKThroughOptim6WithObjectiveFunction(vrep_store)
...
fmincon(@(x)min(IKConstraints(x,vrep_store,0)),x0,[],[],[],[],[],[],@(x)IKConstraints(x,vrep_store,0),options);
